...
<MiddleVR>
    ...
    <DisplayManager Fullscreen="0" WindowBorders="0" ShowMouseCursor="0" VSync="1" AntiAliasing="0" ForceHideTaskbar="0" SaveRenderTarget="0">
        ...
        <Node3D Name="NeckNode" Parent="HeadTracking" Tracker="OculusRift.Tracker" PositionLocal="0.000000,0.000000,0.000000" UseTrackerX="1" UseTrackerY="1" UseTrackerZ="0" UseTrackerYaw="1" UseTrackerPitch="1" UseTrackerRoll="1" />
        <Node3D Name="OffsetHydraToSide" Parent="NeckNode" Tracker="0" PositionLocal="-0.020000,0.040000,0.080000" OrientationLocal="0.000000,0.000000,0.000000,1.000000" />
        <Node3D Name="OffsetRazerHydraHeadTracking" Parent="OffsetHydraToSide" Tracker="0" PositionLocal="0.090000,-0.100000,0.000000" OrientationLocal="0.000000,0.000000,0.000000,1.000000" />
        <Node3D Name="HeadNode" Parent="OffsetRazerHydraHeadTracking" Tracker="0" PositionLocal="0.000000,0.000000,0.000000" OrientationLocal="0.000000,0.000000,0.000000,1.000000" />
        ...
        <Node3D Name="RazerOnOculus" Parent="RazerHydraBaseOffset" Tracker="0" PositionLocal="0.000000,0.000000,0.000000" OrientationLocal="0.000000,0.000000,0.000000,1.000000" />
        <Node3D Name="HandOffset" Parent="RazerHydraBaseOffset" Tracker="0" PositionLocal="-0.080000,0.100000,0.200000" OrientationLocal="0.000000,0.000000,0.000000,1.000000" />
        <Node3D Name="HandNode" Tag="Hand" Parent="HandOffset" Tracker="RazerHydra.Tracker0" UseTrackerX="1" UseTrackerY="1" UseTrackerZ="1" UseTrackerYaw="1" UseTrackerPitch="1" UseTrackerRoll="1" />
